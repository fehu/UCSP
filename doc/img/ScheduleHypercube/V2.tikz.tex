...
\begin{scope}[xshift=-2.5cm, yshift=0cm, sideX, xshift=-5cm, yshift=-1.5cm]
  \mkOuterSide{blue}{red}{G}
\end{scope}
\begin{scope}[xshift=7.5cm, yshift=-3.5cm, sideY]
  \mkOuterSide{blue}{red}{P}
\end{scope}
\begin{scope}[xshift=2.5cm, yshift=10cm, sideZ]
