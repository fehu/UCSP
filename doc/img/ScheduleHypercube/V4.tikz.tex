...
\begin{scope}[xshift=-5cm, sideX, yshift=-1.5cm, xshift=-1.5cm]
  \mkOuterSide{blue}{red}{G}
\end{scope}
\begin{scope}[xshift=5cm, yshift=-4cm, sideY, xshift=3.5cm]
  \mkOuterSide{blue}{red}{P}
\end{scope}
\begin{scope}[xshift=5cm, yshift=11cm, sideZ, xshift=-1.5cm]
